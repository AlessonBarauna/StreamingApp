        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HlsManifestUrl = table.Column<string>(type: "text", nullable: true),
                    OriginalFileKey = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLists_Contents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Contents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLists_ContentId",
                table: "UserLists",
                column: "ContentId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLists_UserId_ContentId",
                table: "UserLists",
                columns: new[] { "UserId", "ContentId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchHistories_UserId_ContentId",
                table: "WatchHistories",
                columns: new[] { "UserId", "ContentId" });
        }
